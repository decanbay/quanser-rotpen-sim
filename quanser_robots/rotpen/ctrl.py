import numpy as np
from .base import RotpenDynamics
...
class EnergyCtrl:
    ...
    def __init__(self, Er, mu, a_max):
        ...
        self._dyn = RotpenDynamics()  # dynamics parameters of the robot
...
class SwingUpCtrl:
    ...
    def __init__(self, ref_energy=0.04, energy_gain=25.0, acc_max=10.0,
