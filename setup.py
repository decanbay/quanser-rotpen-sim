...
setup(name='quanser_robots',
      ...
      license='MIT',
      packages=['quanser_robots', 'quanser_robots.qube', 'quanser_robots.levitation', 'quanser_robots.cartpole', 'quanser_robots.double_pendulum', 'quanser_robots.ball_balancer','quanser_robots.rotpen'],
      zip_safe=False,
      install_requires=[
